            ...
            <div className="actions">
              ...
              <div className="col-f text-right">
                <div className="social-links">
                  ...
                  <a target="_blank" rel="noreferrer" href="https://www.behance.net/Gita-Govinda"><IconBehance width="22px" height="22px" /></a>
                  <a target="_blank" rel="noreferrer" href="https://www.linkedin.com/in/gita-maga%C3%B1a-a18b7b172/"><IconLinkedin width="18px" height="18px" /></a>
                </div>
              </div>
            </div>
          </div>
